...
HD_PWD='D:/Adaboost/OneDrive/mijn/asynchronous_fifo/asynchronous_fifo/asynchronous_fifo.runs/fifo_fifo_generator_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_fifo_generator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_fifo_generator_0_0.tcl
