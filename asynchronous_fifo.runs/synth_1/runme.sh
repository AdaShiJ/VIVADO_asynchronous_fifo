...
HD_PWD='D:/Adaboost/OneDrive/mijn/asynchronous_fifo/asynchronous_fifo/asynchronous_fifo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myFIFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myFIFO.tcl
