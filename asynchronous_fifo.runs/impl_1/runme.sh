...
HD_PWD='D:/Adaboost/OneDrive/mijn/asynchronous_fifo/asynchronous_fifo/asynchronous_fifo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myFIFO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source myFIFO.tcl -notrace
